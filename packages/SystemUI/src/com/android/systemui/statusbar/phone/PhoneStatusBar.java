...
import com.android.internal.utils.eos.EosPackageMonitor;
import com.android.internal.utils.eos.EosSystemReceiver;
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    private EosPackageMonitor mPackageMonitor;
    ...
    private EosSystemReceiver mEosReceiver = new EosSystemReceiver() {
        @Override
...
//        addNavigationBar(true); // dynamically adding nav bar, reset System UI visibility!
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mPackageMonitor = new EosPackageMonitor();
        ...
        context.registerReceiver(mEosReceiver, flashlightFilter);
    ...
    public void destroy() {
        ...
        mContext.unregisterReceiver(mEosReceiver);
