...
import static com.android.internal.navigation.BarTransitions.MODE_LIGHTS_OUT_TRANSLUCENT;
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    private void forceAddNavigationBar() {
        ...
        mNavigationBarView.updateResources(ActionUtils.getNavbarThemedResources(mContext));
    ...
    private void prepareNavigationBarView(boolean forceReset) {
        ...
        mNavigationBarView.setKeyButtonListeners(mHomeActionListener, mUserAutoHideListener);
