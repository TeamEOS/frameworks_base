    ...
    class SettingsObserver extends ContentObserver {
        ...
        public void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    CFXConstants.STATUS_BAR_NETWORK_STATS), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    CFXConstants.STATUS_BAR_NETWORK_STATS_UPDATE_INTERVAL), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    CFXConstants.STATUS_BAR_NETWORK_STATS_TEXT_COLOR), false, this);
            onChange(true);
        }
        ...
        public void onChange(boolean selfChange) {
            ...
            ContentResolver resolver = mContext.getContentResolver();
            mActivated = (Settings.System.getBoolean(resolver,
                    CFXConstants.STATUS_BAR_NETWORK_STATS, false) && networkAvailable);
            ...
            newColor = Settings.System.getInt(resolver,
                    CFXConstants.STATUS_BAR_NETWORK_STATS_TEXT_COLOR, mNetStatsColor);
            if (newColor == -1) {
                mNetStatsColor = mContext.getResources().getColor(
                        com.android.systemui.R.color.status_bar_clock_color);
            } else {
                if (newColor != mNetStatsColor) {
                    mNetStatsColor = newColor;
                }
            }

            if (mTextViewTx != null)
                mTextViewTx.setTextColor(mNetStatsColor);
            if (mTextViewRx != null)
                mTextViewRx.setTextColor(mNetStatsColor);
