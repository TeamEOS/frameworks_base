...
public class HardkeyActionHandler extends ActionHandler {
    ...
    public HardkeyActionHandler(Context context, Handler handler) {
        ...
        mBackButton = new HardKeyButton(context,
                EosConstants.INPUT_HARDKEY_BACK_LONGPRESS,
                EosConstants.INPUT_HARDKEY_BACK_DOUBLETAP, handler, mActionReceiver);

        mHomeButton = new HardKeyButton(context,
                EosConstants.INPUT_HARDKEY_HOME_LONGPRESS,
                EosConstants.INPUT_HARDKEY_HOME_DOUBLETAP, handler, mActionReceiver);

        mRecentButton = new HardKeyButton(context,
                EosConstants.INPUT_HARDKEY_RECENT_SINGLETAP,
                EosConstants.INPUT_HARDKEY_RECENT_LONGPRESS,
                EosConstants.INPUT_HARDKEY_RECENT_DOUBLETAP, handler, mActionReceiver);

        mMenuButton = new HardKeyButton(context,
                EosConstants.INPUT_HARDKEY_MENU_SINGLETAP,
                EosConstants.INPUT_HARDKEY_MENU_LONGPRESS,
                EosConstants.INPUT_HARDKEY_MENU_DOUBLETAP, handler, mActionReceiver);

        mAssistButton = new HardKeyButton(context,
                EosConstants.INPUT_HARDKEY_ASSIST_SINGLETAP,
                EosConstants.INPUT_HARDKEY_ASSIST_LONGPRESS,
                EosConstants.INPUT_HARDKEY_ASSIST_DOUBLETAP, handler, mActionReceiver);
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    EosConstants.INPUT_HARDKEY_ASSIST_SINGLETAP), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    EosConstants.INPUT_HARDKEY_MENU_SINGLETAP), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    EosConstants.INPUT_HARDKEY_RECENT_SINGLETAP), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    EosConstants.INPUT_HARDKEY_ASSIST_DOUBLETAP), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    EosConstants.INPUT_HARDKEY_ASSIST_LONGPRESS), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    EosConstants.INPUT_HARDKEY_BACK_DOUBLETAP), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    EosConstants.INPUT_HARDKEY_BACK_LONGPRESS), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    EosConstants.INPUT_HARDKEY_HOME_DOUBLETAP), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    EosConstants.INPUT_HARDKEY_HOME_LONGPRESS), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    EosConstants.INPUT_HARDKEY_MENU_DOUBLETAP), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    EosConstants.INPUT_HARDKEY_MENU_LONGPRESS), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    EosConstants.INPUT_HARDKEY_RECENT_DOUBLETAP), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
