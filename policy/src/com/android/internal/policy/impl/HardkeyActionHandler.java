...
public class HardkeyActionHandler extends ActionHandler {
    ...
    public HardkeyActionHandler(Context context, Handler handler) {
        ...
        mBackButton = new HardKeyButton(context,
                ...
                CFXConstants.INPUT_HARDKEY_BACK_DOUBLETAP, handler, mActionReceiver);

        mHomeButton = new HardKeyButton(context,
                CFXConstants.INPUT_HARDKEY_HOME_LONGPRESS,
                CFXConstants.INPUT_HARDKEY_HOME_DOUBLETAP, handler, mActionReceiver);
        ...
        mRecentButton = new HardKeyButton(context,
                ...
                CFXConstants.INPUT_HARDKEY_RECENT_DOUBLETAP, handler, mActionReceiver);

        mMenuButton = new HardKeyButton(context,
                CFXConstants.INPUT_HARDKEY_MENU_SINGLETAP,
                CFXConstants.INPUT_HARDKEY_MENU_LONGPRESS,
                CFXConstants.INPUT_HARDKEY_MENU_DOUBLETAP, handler, mActionReceiver);
        ...
        mAssistButton = new HardKeyButton(context,
                ...
                CFXConstants.INPUT_HARDKEY_ASSIST_DOUBLETAP, handler, mActionReceiver);
